...
function is_email_valid_check(from_email) {
  ...
  if (from_email == "") {
    jQuery(".error-msg-email").text("Please Enter Email Address");
    return false;
  }
  if (from_email != "") {
    if (!regex.test(from_email)) {
      jQuery(".error-msg-email").text("Please Enter a Valid From Email");
      return false;
    }
  }
  return true;
...
function getHTMLRow() {
  ...
  var html =
    '<div class="li_' +
    field +
    ' ste-builder-field ste-row-full html_item_row_container html_row">' +
    '<div class="ste-row ste-flex ste-align-center control-box">' +
    '<button class="ste-remove-field ste-icon-field icon icon-close remove_bal_field" data-field="' +
    field +
    '"></button>' +
    "</div>" +
    '<div class="li_row stedb-li-row-flex" data-type="row" data-field="' +
    field +
    '"></div>' +
    "</div>";
  return html;
...
function getTextFieldHTML(parentId) {
  ...
  var html =
    '<div class="li_' +
    field +
    '  ste-builder-field ste-row stedb-col">' +
    '<div class="ste-flex ste-justify-space ste-align-center">' +
    '<button class="ste-remove-field ste-icon-field icon icon-close remove_bal_field" data-field="' +
    field +
    '"></button>' +
    "</div>" +
    '<div id="text-box" class="li_row  form_output" data-type="text" data-field="' +
    field +
    '" data-parent-field="' +
    parentId +
    '">' +
...
function getNumberFieldHTML(parentId) {
  ...
  var html =
    ...
    '"></button>' +
    "</div>" +
    '<div class="li_row form_output" data-type="number" data-field="' +
    field +
    '" data-parent-field="' +
    parentId +
    '">' +
...
function getRadioFieldHTML(parentId) {
  ...
  var html =
    ...
    '"></button>' +
    "</div>" +
    '<div class="li_row form_output" data-type="radio" data-field="' +
    field +
    '" data-parent-field="' +
    parentId +
    '">' +
    ...
    '">' +
    // +'</div>'
    '<div class="field_extra_info_' +
    field +
    '">' +
    '<div class="ste-radio-list my-3 radio_row_' +
    field +
    '" data-field="' +
    field +
    '" data-opt="' +
    opt1 +
    '"> ' +
    '<div class=" ste-flex mt-radio radio_list_' +
    field +
    '">' +
    ...
    '<button class="ste-add-more ste-btn-add-option add_more_radio" data-field="' +
    field +
    '">+ Add</button>' +
    "</div>" +
    "</div>" +
...
function getCheckboxFieldHTML() {
  ...
  var html =
    ...
    '"></button>' +
    "</div>" +
    '<div class="li_row form_output" data-type="checkbox" data-field="' +
    field +
    '">' +
    '<input type="text" name="label_' +
    field +
    ...
    field +
    '">' +
    '<div class="ste-checkbox-list my-3 checkbox_row_' +
    field +
    '" data-field="' +
    field +
    '" data-opt="' +
    opt1 +
    '">' +
    '<div class="ste-flex mt-checkbox checkbox_list_' +
    field +
    '">' +
    ...
    '<button class="ste-add-more ste-btn-add-option add_more_checkbox" data-field="' +
    field +
    '">+ Add</button>' +
    "</div>" +
    "</div>" +
...
function getSelectFieldHTML() {
  ...
  var html =
    ...
    '"></button>' +
    "</div>" +
    '<div class="li_row form_output" data-type="select" data-field="' +
    field +
    '">' +
    '<input type="text" name="label_' +
    field +
    '" class="ste-field form_input_label form-control" placeholder="Enter your label here" data-field="' +
    field +
    '">' +
    // +'</div>'
    ...
    '<select name="select_' +
    field +
    '" class="ste-selectbox form-control mb-3  ste-selectbox-value col-3 mr-3">' +
    '<option value="">Select Option</option>' +
    '<option data-opt="' +
    opt1 +
    '" value="Value">Option 1</option>' +
    "</select>" +
    '<button class="ste-add-more ste-btn-add-option add_more_select" data-field="' +
    field +
    '">+ Add</button>' +
    "</div>" +
    '<div class="field_extra_info_' +
...
function getDateFieldHTML(parentId) {
  ...
  var html =
    ...
    '"></button>' +
    "</div>" +
    '<div class="li_row form_output" data-type="date" data-field="' +
    field +
    '" data-parent-field="' +
    parentId +
    '">' +
...
function getYahooHTML(parentId) {
  ...
  var html =
    ...
    field +
    ' ste-builder-field ste-row  stedb-col">' +
    '<div class="li_row form_output ste-flex ste-my-0-5" data-type="social_yahoo" data-field="' +
    field +
    '" data-parent-field="' +
    parentId +
    '">' +
    ...
    '<img src="' +
    site_url +
    'admin/images/yahoo.png">' +
    // '<img src="' + site_url + 'admin/images/vertical_yh.png">' +
    '<span class="align-self-center">Submit via Yahoo!</span>' +
    "</a>" +
    "</div>" +
    '<button class="ste-remove-field ste-icon-field icon icon-close remove_social_bal_field" data-field="' +
    field +
    '"></button>' +
    "</div>" +
    "</div>";
...
function getGmailHTML(parentId) {
  ...
  var html =
    '<div class="li_' +
    field +
    ' ste-builder-field ste-row ste-height-auto stedb-col">' +
    '<div class="li_row form_output ste-flex ste-my-0-5" data-type="social_gmail" data-field="' +
    field +
    '" data-parent-field="' +
    parentId +
    '">' +
...
function getLinkedinHTML(parentId) {
  ...
  var html =
    ...
    field +
    ' ste-builder-field ste-row ste-height-auto stedb-col">' +
    '<div class="li_row form_output ste-flex ste-my-0-5" data-type="social_linkedin" data-field="' +
    field +
    '" data-parent-field="' +
    parentId +
    '">' +
    ...
    "</a>" +
    "</div>" +
    '<button class="ste-remove-field ste-icon-field icon icon-close remove_linkedin_bal_field" data-field="' +
    field +
    '"></button>' +
    "</div>" +
    "</div>";
...
(function ($) {
      ...
      drop: function (event, ui) {
        ...
        if (ui.helper.find("[data-type]").attr("data-type") == "social_yahoo") {
          ...
          if (".social_yahoo" != -1) {
            ...
            jQuery(".social_yahoo")
              .closest(".ste-social-icon")
              .append(
                "<a href='javascript:void(0);' title='Due to some technical restrictions, Yahoo and Gmail cannot be used together in one form.' class='help'>&#8505;</a>"
              );
            jQuery(".social_gmail")
              .closest(".ste-social-icon")
              .append(
        ...
        if (
          ui.helper.find("[data-type]").attr("data-type") == "social_linkedin"
        ) {
  ...
  $(
    ".text_box, .text_area, .number_box, .number_box, .radio_button, .checkbox, .select_box, .date_box, .link_box, .social_yahoo, .social_gmail, .social_linkedin"
  ).draggable({
    start: function (event, ui) {
      if (jQuery("#ste-sortable").find("[data-type='row']").length <= 0) {
        $(
          ".text_box, .text_area, .number_box, .number_box, .radio_button, .checkbox, .select_box, .date_box, .link_box"
        ).draggable("disable");
        $(".sp-container").show();
        $(".arrow_message").show();
        var full_html_code =
          '<div class="sp-container"><div class="sp-content"><div class="sp-globe"></div><h2 class="frame-1">Please Drag The Row First !</h2></div></div>';
    ...
    $(this)
      ...
      .hide("400", function () {
        ...
        if ($(this).hasClass("html_row")) {
          if (
            $(this).find(
              "[data-type='social_gmail'],[data-type='social_yahoo']"
            ).length > 0
          ) {
  ...
  $(document).on("click", ".add_more_radio", function () {
    ...
    $(".field_extra_info_" + field).append(
      '<div class="mt-radio ste-my-0-5 radio_row_' +
        field +
        '"  data-field="' +
        field +
        '" data-opt="' +
        option +
        '">' +
        '<div class=" ste-flex radio_list_' +
        field +
        '">' +
        '<label class="ste-custom-input ste-flex  ste-mt-0-2">' +
        '<input data-opt="' +
        ...
        '<button class="ste-add-more ste-btn-remove-option remove_more_radio" data-field="' +
        field +
        '">x</button>' +
        "</div>" +
        "</div>"
  ...
  $(document).on("click", ".add_more_checkbox", function () {
    ...
    var option = generateField();
    $(".field_extra_info_" + field).append(
      '<div class="ste-checkbox-list  checkbox_row_' +
        field +
        '" data-field="' +
        field +
        '" data-opt="' +
        option +
        '">' +
        '<div class="ste-flex mt-checkbox my-3 checkbox_list_' +
        field +
        '">' +
        '<label class="ste-custom-input ste-flex ">' +
        '<input data-opt="' +
        ...
        '<button class="ste-add-more  ste-btn-remove-option remove_more_checkbox" data-field="' +
        field +
        '">x</button>' +
        "</div>" +
        "</div>"
  ...
  $(document).on("click", ".add_more_select", function () {
    ...
    $(".field_extra_info_" + field).append(
      '<div data-field="' +
        ...
        '<button class="ste-add-more ste-btn-remove-option remove_more_select" data-field="' +
        field +
        '" data-opt="' +
        option +
        '" >x</button>' +
  ...
  $(document).on("click", ".remove_more_select", function () {
    ...
    $(this)
      ...
      .hide("400", function () {
        $(this).remove();
        var remove_opt = $(
          "select[name=select_" + field + "] option[data-opt=" + opt + "]"
        );
        remove_opt.remove();
        var options = "";
        $(".select_row_" + field).each(function () {
  ...
  function getPreview(plain_html = "") {
    ...
    formRows.each(function () {
      ...
      elTmp.each(function (i) {
        //elements form output process[started]
        var data_type = $(this).attr("data-type");
        var label = $(this).find(".form_input_label").val();
        var name = $(this).find(".form_input_name").val();
        if (data_type == "text") {
          html +=
            '<div class="ste-mb-1 stedb-col form-group form_builder_field_preview" data-group_name="' +
            label.toLowerCase().replace(/ /g, "_") +
            '" data-group_type="' +
            data_type +
            '" ><div class=""><label class="control-label ste-public-form-label-text ">' +
            label +
            '</label></div><div class=" text-field"><input type="text" name="' +
            label.toLowerCase().replace(/ /g, "_") +
            '" class="form-control ste-container-alpha text-field" /></div></div>';
          field_detail_array[index++] = {
        ...
        if (data_type == "textarea") {
          html +=
            ...
            '" ><div class=""><label class="control-label ste-public-form-label-text ">' +
            label +
            '</label></div><div class="ste-textbox textarea-field"><textarea rows="5" name="' +
            label.toLowerCase().replace(/ /g, "_") +
            '" class="form-control textarea-field" /></textarea></div></div>';
          field_detail_array[index++] = {
            field_name: label.toLowerCase().replace(/ /g, "_"),
            field_type: data_type,
            default_value: label,
        ...
        if (data_type == "number") {
          html +=
            ...
            '" ><div class=""><label class="control-label ste-public-form-label-text ">' +
            label +
            '</label></div><div class=" number-field"><input type="number" name="' +
            label.toLowerCase().replace(/ /g, "_") +
            '" class="form-control number-field" /></div></div>';
          field_detail_array[index++] = {
            field_name: label.toLowerCase().replace(/ /g, "_"),
            field_type: data_type,
            default_value: label,
        ...
        if (data_type == "url") {
          html +=
            ...
            '" ><div class=""><label class="control-label ste-public-form-label-text ">' +
            label +
            '</label></div><div class=" link-field"><input type="url" name="' +
            label.toLowerCase().replace(/ /g, "_") +
            '" class="form-control link-field" /></div></div>';
          field_detail_array[index++] = {
            field_name: label.toLowerCase().replace(/ /g, "_"),
            field_type: data_type,
            default_value: label,
        ...
        if (data_type == "date") {
          html +=
            ...
            '" data-group_type="' +
            data_type +
            '" ><div class=""><label class="control-label ste-public-form-label-text ste-flexb-20">' +
            label +
            '</label></div><div class=" dat-field"><input type="date" name="' +
            label.toLowerCase().replace(/ /g, "_") +
            '" class="form-control date-field" /></div></div>';
          field_detail = {
            field_name: label,
            field_type: data_type,
            default_value: label.toLowerCase().replace(/ /g, "_"),
          };
          field_detail_array[index++] = {
            field_name: label.toLowerCase().replace(/ /g, "_"),
            field_type: data_type,
        ...
        if (data_type == "select") {
          ...
          html +=
            '<div class="ste-mb-1 form-group form_builder_field_preview stedb-col" data-group_name="' +
            label.toLowerCase().replace(/ /g, "_") +
            '" data-group_type="' +
            data_type +
            '" ><div class=""><label class="control-label ste-public-form-label-text ste-flexb-20">' +
            label +
            '</label></div><div class=""><select class="form-control form-dropdown-field ste-select" name="' +
            label.toLowerCase().replace(/ /g, "_") +
            '">' +
            option_html +
            "</select></div></div>";
        ...
        if (data_type == "radio") {
          ...
          $(this)
            ...
            .each(function () {
              ...
              option_html +=
                '<div class="form-check ste-mr-0-5 stedb-col"><label class="form-check-label"><input style="margin: 0px 5px 0px 0px;  vertical-align: middle;" type="radio" class="form-radio-field" name="' +
                label.toLowerCase().replace(/ /g, "_") +
                '" value="' +
                option +
                '">' +
          ...
          html +=
            '<div class="ste-mb-1 form-group form_builder_field_preview" data-group_name="' +
            label.toLowerCase().replace(/ /g, "_") +
            '" data-group_type="' +
            data_type +
            '"><label class=" ste-public-form-label-text control-label">' +
            label +
            "</label>" +
            option_html +
            "</div>";
        ...
        if (data_type == "checkbox") {
          ...
          $(this)
            ...
            .each(function () {
              var option = $(this).find("input[type=text]").val();
              option_html +=
                '<div class="form-check ste-mr-0-5 stedb-col"><label class="form-check-label "><input style="margin: 0px 5px 0px 0px; border-radius:5px; vertical-align: middle;" type="checkbox" data-name="' +
                label.toLowerCase().replace(/ /g, "_") +
                '" class="form-checkbox-field" name="' +
                label.toLowerCase().replace(/ /g, "_") +
                '[]" value="' +
                option +
                '">' +
          ...
          field_detail_array[index++] = {
            field_name: label.toLowerCase().replace(/ /g, "_"),
            field_type: data_type,
            default_value: checkbox_arr,
          };
        }
        if (data_type == "social_yahoo") {
          html +=
            '<div class="ste-mb-1 form-group form_builder_field_preview stedb-col" data-group_name="social_yahoo" data-group_type="' +
            data_type +
            '" ><div class="sign-up-button ste-sign-up-button yh"><a style="text-decoration:none" class="form_save" social-yahoo="s_yahoo"><img src="' +
            site_url +
            'admin/images/yahoo.png"><span class="align-self-center">Submit via Yahoo!</span></a></div></div>';
          field_detail_array[index++] = { field_type: data_type };
        }
        if (data_type == "social_gmail") {
          html +=
            '<div class="ste-mb-1 form-group form_builder_field_preview stedb-col" data-group_name="social_gmail" data-group_type="' +
            data_type +
            '"><div class="sign-up-button ste-sign-up-button gp"><a style="text-decoration:none" class="form_save" social-gmail="s_gmail"><img src="' +
            site_url +
            'admin/images/gmail.png"><span class="align-self-center">Submit via Gmail</span></a></div></div>';
          field_detail_array[index++] = { field_type: data_type };
        }
        if (data_type == "social_linkedin") {
          html +=
            '<div class="ste-mb-1 form-group form_builder_field_preview stedb-col" data-group_name="social_linkedin" data-group_type="' +
            data_type +
            '" ><div class="sign-up-button  ste-sign-up-button ln"><a style="text-decoration:none" class="form_save" social-linkedin="s_linkedin"><img src="' +
            site_url +
            'admin/images/linkedin.png"><span class="align-self-center">Submit via Linkedin</span></a></div></div>';
          field_detail_array[index++] = { field_type: data_type };
        }
    ...
    if (plain_html == "html") {
      ...
      if (
        full_html_code.indexOf("social_yahoo") != -1 ||
        full_html_code.indexOf("social_gmail") != -1 ||
        full_html_code.indexOf("social_linkedin") != -1
      ) {
        if (form_id != undefined) {
          $.ajax({
            ...
            type: "post",
            data: {
              action: "ste_update_form_builder_data",
              nonce: ste.nonce,
              form_id: form_id,
              html_code: html,
              full_html_code: full_html_code,
              form_name: form_name,
              receiver: receiver,
              field_detail_array: field_detail_array,
            },
            dataType: "json",
            beforeSend: function () {
              $("#loader").show();
          ...
          $.ajax({
            ...
            type: "post",
            data: {
              action: "ste_create_form_builder_data",
              nonce: ste.nonce,
              html_code: html,
              full_html_code: full_html_code,
              form_name: form_name,
            ...
            success: function (response) {
              if (response.success) {
                ...
                window.location.href =
                  web_url +
                  "/wp-admin/admin.php?page=ste-form-builder&action=form_creation_div&id=" +
                  response.form_id;
              }
            },
          });
        ...
        alert(
          "Please select at least one social button from Email fields section"
        );
        return false;
      }
    } else {
  ...
  $(document).ready(function () {
    ...
    $("#receiver").focusout(function () {
      ...
      $.ajax({
        ...
        type: "post",
        data: {
          action: "check_stedb_email_exist",
          nonce: ste.nonce,
        ...
        success: function (response) {
          ...
          if (
            response.success &&
            response.message == "From email saved, confirmation message sent"
          ) {
            $(".error-msg-email").html(
              '<button class="btn btn-success ste-btn-autoresponder " id="verify_email_stedb">Verify Email</button>'
            );
            $(".create_form").prop("disabled", true);
          } else if (
            response.success &&
            response.message ==
              "There was to many attempts, please contact support"
          ) {
            $(".error-msg-email").html(
              '<button class="btn btn-success ste-btn-autoresponder " id="verify_email_stedb">Verify Email</button>'
            );
      ...
      $.ajax({
        ...
        success: function (response) {
          if (response.success) {
            if (
              filter != undefined &&
              (filter == "restore" || filter == "delete_permanent")
            ) {
              window.location.href =
                site_url +
                "/wp-admin/admin.php?page=ste-form-builder&filter=trash";
            } else {
              window.location.href =
                site_url + "/wp-admin/admin.php?page=ste-form-builder";
            }
          }
        },
      });
    ...
    $(document).on("click", ".delete_form", function () {
      ...
      $.ajax({
        ...
        type: "post",
        data: {
          action: "ste_delete_form_builder_data",
          nonce: ste.nonce,
          form_id: form_id,
        },
        dataType: "json",
  ...
  if (formID != undefined) {
    $.ajax({
      ...
      success: function (response) {
        ...
        if (
          $("#ste-sortable").find("[data-type='social_linkedin']").length > 0
        ) {
          jQuery(".social_linkedin").draggable("disable");
        }
      },
  ...
  $(document).on("click", "#contact_form", function () {
    ...
    if (
      $("#ste-sortable").find(
        "[data-type='social_gmail'],[data-type='social_yahoo'],[data-type='social_linkedin']"
      ).length > 0
    ) {
      jQuery(".social_gmail").draggable("disable");
      jQuery(".social_yahoo").draggable("disable");
  ...
  $(document).on("click", ".update_send_address", function (e) {
    ...
    $.ajax({
      ...
      type: "post",
      data: {
        action: "ste_send_update_address",
        address: address,
        address2: address2,
        city: city,
      ...
      success: function (response) {
        $("#loader1").hide();
        if (response.success) {
          $(".ajax-message-settings").html(
            '<div style="margin:15px 0px"><b style="color:green;font-size: 15px;">Successfully Saved</b></div>'
          );
        } else {
          $(".ajax-message-settings").html(
            '<div style="margin:15px 0px"><b style="color:red;font-size: 15px;">' +
              response.message +
              "</b></div>"
          );
        }
