	...
	<div class="row">
		...
		<div class="col-9  draggable-area ">
			...
			<div class="row ste-form-builder-btn">
				<div class="col py-3">
					<button type="button" class="btn btn-primary ste-form-btn-show-shortcode  ste-form-btn-show-shortcode-disable create_form " id="save-form"><span class="icon icon-code "></span><?php esc_html_e('Save my form', 'ste-social-form-builder'); ?></button>
