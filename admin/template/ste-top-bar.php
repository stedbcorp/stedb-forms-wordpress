...
<div class="ste-container">
	<div class=" ste-header-section ">
		<div class="row   ste-top-bar">
			<div class="col-5 align-self-center py-4">
				<span class="ste-header-title white"><?php esc_html_e("Easy drag & drop STEdb's form builder", 'ste-social-form-builder'); ?></span>
			</div>
			<div class=" col-7 ste-header-icons">
				<div class="row">
					<div class="align-self-center"><span class="icon icon-account-id"></span></div>
					<div class="col py-4 ">
						<span class="text-white"><?php esc_html_e('More Email templates, Drip Marketing, Manage your email lists and more!
ACCESS your online account here:', 'ste-social-form-builder'); ?></span>
						<a class=" alert-link" target="_blank" href="<?= $link ?>"><?php esc_html_e(get_option('stedb_secret')); ?></a>
					...
					<div class="col-5 align-self-center py-4">
						...
						<a class="f-clr" href="tel:+15612285630"><?php esc_html_e('+1 (561) 228-5630', 'ste-social-form-builder'); ?></a> <br />
