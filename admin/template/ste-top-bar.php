...
<button type="button" id="show_preview" name="show_preview" class="preview_form btn btn-secondary  ste-btn-preview"><span class="icon icon-view white"></span><?php esc_html_e( '  Preview', 'ste-social-form-builder' ); ?></button>
<button type="button" class="btn btn-success set_email_draft ste-btn-draft" name="ste-btn-draft"><span class="icon icon-tick white"></span><?php esc_html_e( ' Save', 'ste-social-form-builder' ); ?></button>
						</div>
					</div>
				</div>
<!-- links end -->
